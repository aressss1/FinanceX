        ...
        <div className="bg-special py-20  " >
            ...
            <div className='flex items-center justify-center gap-6 '>
                {reviews.slice(startIndex, startIndex + 3).map((review, index) => (
                    <Card key={review.name} className="bg-black w-96 md:w-56 border-none flex flex-col  rounded-none p-10 md:p-2 gap-5 transition-all duration-500 transform hover:scale-105 " >
