...
const OurBenefits = () => {
    return ( 
        <div className="flex flex-row justify-between lg:px-20 py-12 lg:gap-3 md:px-12 md:gap-6 bg-black" >
            <div className="w-[28rem] flex flex-col gap-8" >
            <div className="text-special lg:text-xl md:text-base font-semibold">
                Benefits
            </div>
            <div>
                <span className="text-white lg:text-5xl md:text-4xl font-bold leading-10">We have many users all over the </span><span className="text-special lg:text-5xl  md:text-4xl font-bold leading-10">world</span>
            </div>
            ...
            <div className='flex flex-row justify-between' >
                <div className='flex flex-col justify-between gap-3 ' >
                    <div className='flex flex-row items-center lg:text-3xl md:text-2xl text-white uppercase ' >
                        10M
