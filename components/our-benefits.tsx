...
const OurBenefits = () => {
    return ( 
        <div className="flex flex-row justify-between px-20 py-12 md:px-12  bg-black" >
            ...
            <div>
                <span className="text-white text-5xl md:text-4xl font-bold leading-10">We have many users all over the </span><span className="text-special text-5xl  md:text-4xl font-bold leading-10">world</span>
            </div>
            ...
            <div className='flex flex-row justify-between' >
                <div className='flex flex-col justify-between gap-3 ' >
                    <div className='flex flex-row items-center text-3xl md:text-2xl text-white uppercase ' >
                        10M
