    ...
    return (
        <div className="flex flex-col gap-16 md:flex-row justify-between px-2 lg:px-20 py-12 lg:gap-3 md:px-12 md:gap-6 bg-black" >
            <div className="w-72 md:w-[28rem] flex flex-col gap-6 md:gap-8" >
                ...
                <div>
                    <span className="text-white text-xl lg:text-5xl md:text-4xl font-bold leading-6 md:leading-10">We have many users all over the </span><span className="text-special  text-xl lg:text-5xl  md:text-4xl font-bold ">world</span>
                </div>
