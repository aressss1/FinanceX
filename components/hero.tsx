    ...
    return (
        <div className="h-[37rem] flex bg-black items-center justify-between" >
            <div className="w-[38rem] flex flex-col lg:pl-20 md:pl-12 gap-5  " >
                <div className="text-special text-base md:text-xl font-semibold">
                ...
                <div className=" text-white text-opacity-70 text-sm lg:text-lg md:text-base font-normal leading-relaxed">
